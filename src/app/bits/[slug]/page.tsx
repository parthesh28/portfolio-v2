        ...
        <div className="h-[100dvh] w-full relative overflow-hidden flex flex-col items-center justify-center pt-24 pb-24 px-6">
            <div className="w-full max-w-2xl flex flex-col gap-6">
                <div className="flex items-center justify-between w-full">
                    <Link
                        href="/bits"
                        className="group flex items-center gap-2 text-lg font-bold lowercase "
                    >
                        <i className="hn hn-arrow-left text-lg"></i>
                        <span>back</span>
                    </Link>
                    <div className="card border-2 px-3 py-1.5 flex items-center gap-3 text-[10px] sm:text-xs font-bold lowercase">
                        <span>{bit.date}</span>
                ...
                <h1 className="text-3xl sm:text-4xl font-bold lowercase leading-tight text-zinc-900 dark:text-zinc-100">
                    {bit.title}
                </h1>

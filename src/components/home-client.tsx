      ...
      <div className="w-full max-w-[95vw] sm:max-w-4xl md:max-w-5xl lg:max-w-6xl flex flex-col md:flex-row items-center justify-center gap-responsive md:gap-6 lg:gap-12">
        ...
        <article className="flex flex-col gap-responsive md:gap-4 lg:gap-5 max-w-lg w-full">
          ...
          <section className="flex flex-col border-l-2 border-current pl-3 md:pl-4">
            <blockquote className="body-responsive md:text-lg font-medium leading-snug whitespace-nowrap">
              <span className="text-xl sm:text-3xl md:text-4xl font-bold select-none opacity-50 align-[-0.2em] mr-0.5 md:mr-1 inline-block">&ldquo;</span>
              <em>i can love anything if i spend enough time with it.</em>
              <span className="text-xl sm:text-3xl md:text-4xl font-bold select-none opacity-50 align-[-0.35em] ml-0.5 md:ml-1 inline-block">&rdquo;</span>
            </blockquote>
          </section>
          ...
          <section className="flex flex-col gap-1.5 md:gap-3 border-l-2 border-current pl-3 md:pl-4">
            ...
            <div className="flex flex-row items-center gap-3 md:gap-8 overflow-hidden flex-wrap">
              ...
              <pre
                className="font-mono font-black select-none whitespace-pre text-current shrink-0"
                style={{ fontSize: '2.35px', lineHeight: '2.30px' }}
              >
                {TYPESCRIPT_ASCII}
              </pre>
            </div>
